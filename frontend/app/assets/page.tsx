    ...
    <div className="max-w-2xl mx-auto px-6 py-12 animate-fade-in">
      ...
      {assetData && !isLoading && (
        <div className="space-y-4">
          <div className="bg-white rounded-xl border border-gray-200 p-6 hover:border-gray-300 hover:shadow-sm transition-all">
            <div className="flex items-start justify-between mb-5 gap-4">
              ...
              {isVerified ? (
                ...
                <span className="px-2.5 py-1 rounded-full bg-gray-50 border border-gray-200 text-gray-600 text-xs font-medium whitespace-nowrap">
                  Unverified
                </span>
              )}
            </div>
          ...
          {isVerified ? (
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <span className="px-2.5 py-1 rounded-full bg-green-50 border border-green-200 text-green-700 text-xs font-medium inline-block mb-4">
                Verified
              </span>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              <p className="text-sm text-gray-600 mb-5 leading-relaxed">
                ...
                bounty to invite expert review, or stake to verify it yourself.
              </p>

              {bountyAmount !== undefined && (
                <div className="rounded-lg border border-gray-200 bg-gray-50 px-3 py-2.5 mb-4 text-sm text-gray-700">
                  Current bounty:{" "}
              ...
              <div className="border border-gray-200 rounded-lg p-4 mb-3">
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  <input
                    ...
                    className="flex-1 border border-gray-200 rounded-lg px-3 py-2 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 outline-none bg-white text-gray-900 placeholder:text-gray-400 transition-colors"
                  />
                  <button
                    onClick={handleRequestVerification}
                    disabled={pendingAction !== null}
                    className="border border-gray-200 hover:border-gray-300 bg-white text-gray-700 rounded-lg px-4 py-2 font-medium text-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  ...
                  <button
                    ...
                    disabled={pendingAction !== null}
                    className="bg-blue-600 hover:bg-blue-700 text-white rounded-lg px-4 py-2 font-medium text-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
              ...
              {isDisputed ? (
                <div>
                  ...
                  <p className="text-sm text-gray-900 mb-1">
                    Filed by{" "}
                    <span className="font-mono">{shorten(disputeOpener)}</span>
                  </p>
                  <p className="text-sm text-gray-600">
                ...
                <div>
                  ...
                  <button
                    ...
                    disabled={pendingAction !== null}
                    className="bg-red-50 hover:bg-red-100 text-red-600 border border-red-200 rounded-lg px-4 py-2 font-medium text-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
          ...
          {historyData.length > 0 && (
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <h3 className="text-xs uppercase tracking-wide text-gray-400 mb-5">
